			...
			<ul>
				...
				<li>
					...
					<a
						...
						target='_blank'>
						https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_theActions.settings_for_disabling__or_deleting_local_shared_objects_
					</a>
				</li>
				<li>
