...
const eventData = {
	...
	shop   : [
		...
		{ name: 'T3 Triple 152mm Main Gun (B-38 MK5) Design', cost: 135, amount: 15 },
		{ name: 'Twin 130mm B-2LM Main Gun Mount', cost: 2000, amount: 1 },
		{ name: 'Intel Report - Arctic Stronghold', cost: 1000, amount: 1 },
		{ name: 'General Blueprint - Series 2', cost: 500, amount: 30 },
		{ name: 'Special General Blueprint - Series 2', cost: 1000, amount: 10 },
		{ name: 'Cognitive Chips', cost: 300, amount: 10 },
		{ name: 'Shipbuilding Support Ticket', cost: 500, amount: 5 },
